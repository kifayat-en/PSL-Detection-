...
<h2>Result</h2>
- Achieved high training and validation accuracy on PSL dataset.
- Model successfully recognizes PSL signs in real-time using a webcam.
- Lightweight model (few MB) → suitable for mobile/web apps.
